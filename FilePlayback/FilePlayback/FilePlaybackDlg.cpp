...
void CFilePlaybackDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Control(pDX, IDC_PLAY_BUTTON, m_playPauseButton);
...
BEGIN_MESSAGE_MAP(CFilePlaybackDlg, CDialog)
	...
	ON_WM_QUERYDRAGICON()
	//}}AFX_MSG_MAP
	ON_BN_CLICKED(IDC_PLAY_BUTTON, &CFilePlaybackDlg::OnBnClickedPlayPause)
...
void CFilePlaybackDlg::UpdateInterface()
{
	...
	m_playPauseButton.EnableWindow(m_playbackState != PlaybackState::OutputDisabled);
	m_filePositionSlider.EnableWindow(m_playbackState == PlaybackState::OutputEnabled);

	m_playPauseButton.SetWindowText(m_playbackState == PlaybackState::ScheduledPlayback ? _T("Pause") : _T("Play"));
}

void CFilePlaybackDlg::OnBnClickedPlayPause()
{
